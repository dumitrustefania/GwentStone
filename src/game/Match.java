...
public class Match extends Game {
    ...
    /**
     * Unfreeze and unmark as attacker the player's cards.
     * @param player
     */
    public void unfreezeAndReinitCards(final Player player) {
        // get the player's rows on the table
        ...
        // traverse each row and remove the card from both frozen and attacker arrays
        ...
        // remove the hero from the attacker array
